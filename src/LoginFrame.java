...
public class LoginFrame extends JFrame {
    private Connection connection;
        public LoginFrame() {
            ...
            JTextField textFieldEmail = new JTextField("doaa@gmail.com");
            textFieldEmail.setPreferredSize(new Dimension(150, 30));
            JPasswordField textFieldPassword = new JPasswordField("123");
...
//                        openClinicPage(authenticatedUser);
                    Main mainFrame = new Main(authenticatedUser);
                    mainFrame.pack();
