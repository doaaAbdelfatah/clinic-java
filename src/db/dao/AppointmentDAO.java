...
public class AppointmentDAO {
    ...
    public void add(Appointment appointments) throws SQLException {
    ...
    public  void update(Appointment appointments) throws SQLException {
    ...
    public ArrayList<Appointment> get() throws SQLException {
        ...
        while (resultSet.next()){
            ...
            User users=userDao.get(resultSet.getInt("user_id"));
            a.setUser(users);
